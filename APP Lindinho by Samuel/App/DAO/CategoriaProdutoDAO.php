...
class CategoriaProdutoDAO
{
    ...
    public function insert(CategoriaProdutoModel $model)
    {
        ...
        $stmt->bindValue(1, $model->nome_categoria);
    ...
    {
        $sql = "UPDATE categoriaproduto  SET nome_categoria=? WHERE id=? ";
    ...
    public function selectById(int $id)
    {
        ...
        return $stmt->fetchObject("CategoriaProdutoModel"); // Retornando um objeto específico PessoaModel
    }
